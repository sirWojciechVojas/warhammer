...
class ChatsModel extends Model {
	...
	public function getGold() {
		...
		return $this->db->table('w_bg_current')->select('FLOOR(BRASS/7680) as mCrown, FLOOR((BRASS%7680)/64) as mShilling, (BRASS%7680)%32 as mPenny, BRASS as hBrass')->getWhere(['USEDNAME_ID'=>$this->ID])->getRow();
	}
