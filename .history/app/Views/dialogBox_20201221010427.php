      		...
      		<div class="modal-body<?=$addClass?>" style="padding:0 15px;">
				...
				<?php elseif($prefix == 'Inv'): ?>
					...
					<div class="col-md-10 predesc">
						...
						<div class="align-middle"><?=$item['HANDED']?></div>
						<?php else: ?>
						<div class="align-middle"><b>Obciążenie: </b><?=$item['CHARGE']?> jednostek</div>
						<?php endif ?>
						<div class="align-middle"><b>Wartość: </b><?=$item['PRIZE']?> brass</div>
					</div>
					<?php if($item['ITEM_CLASS'] == 'WEAPON'): ?>
