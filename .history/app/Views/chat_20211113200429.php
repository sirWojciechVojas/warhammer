            ...
            <div class="modal-body" style="padding-top:0;">
                <div class="row d-flex">
                    ...
                    <div class="col-md-2 d-flex flex-column flank align-items-center justify-content-around">
                        <button class="btn btn-secondary  square justify-content-center">Szblony-dodaj/edytuj</button>
                        <button class="btn btn-info card square justify-content-center">Stos - spersonalizuj</button>
                        <button class="btn btn-info card square justify-content-center">Sklep-ustal asortyment</button>
                    </div>
