...
<div class="row align-items-center h-100 justify-content-md-center" style="display:none;">
    <div class="col-md-10" id="characterStats">
        ...
        <div class="row">
            ...
            <div class="col-md-4 cPanel cCenter">
                <div class="row">
                    <div class="col-md-12 title">Cechy Bohatera2</div>
                    ...
                    <div class="col-md-12 title">Umiejętności3 i Zdolności</div>
                </div>
            </div>
            <div class="col-md-4 cPanel cRight">
                <div class="row">
                    ...
                    <div class="col-md-12 name"><?= $BG['NAME'] ?></div>
                    <?php if ($BG['NAME'] !== $BG['USEDNAME']) : ?>
                    <div class="col-md-12 usedname"><i><b>Twoja falszywa tożsamość:</b></i>
                        <span><?= $BG['USEDNAME'] ?></span>
                    </div>
                    <?php endif;
					$BG_h = explode('|', $BG['HISTORY']); ?>
