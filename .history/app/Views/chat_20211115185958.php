            ...
            <div class="modal-footer justify-content-center pm-0">
                <div class="row d-flex w-100 pm-0">
                    <div class="col-md-12 d-flex justify-content-space-around pm-0">
                        <div class="row d-flex w-100 pm-0 bg-light">
                        <?php foreach($invItem as $ival): ?>
                                <div class="col-md-6 d-flex pm-0 w-100 h-auto justify-content-around">
                                <?php foreach($ival as $iv): ?>
                                    <div title="<?=$iv?>" class="p-2 btn bg-dark inventory-item <?=$iv?> text-light mb-2"></div>
                                <?php endforeach; ?>
                                </div>
