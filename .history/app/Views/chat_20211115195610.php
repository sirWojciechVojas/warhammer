                ...
                <div class="row d-flex w-100 pm-0">
                    <div class="col-md-12 d-flex justify-content-space-around pm-0">
                        ...
                        <?php foreach($invItem as $ival): ?>
                                <div class="col-md-6 d-flex pt-1 mt-1 pm-0 w-100 h-auto bg-secondary justify-content-around">
                                <?php foreach($ival as $iv): ?>
                                    <div title="<?=$iv?>" class="p-2 bg-dark inventory-item <?=$iv?> text-light"></div>
                                <?php endforeach; ?>
                                </div>
