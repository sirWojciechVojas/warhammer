        ...
        <div class="modal-content" id="tradingStats">
            ...
            <div class="modal-body" style="padding-top:0;">
                <div class="row d-flex">
                    ...
                    <div class="col-md-2 d-flex flex-column flank align-items-center justify-content-evenly"></div>
                    <div class="col-md-4 d-flex flex-column align-items-end">
                        ...
                        <div id="tradingBuy" class="outline w-100 h-75 text-light bg-transparent pm-0 mb-2"></div>
                        ...
                        <button id="tBuyBtn" class="btn btn-secondary w-50 align-self-center mt-auto disabled">Kup</button>
                    </div>
                    <div class="col-md-4 d-flex flex-column align-items-start">
                        ...
                        <div id="tradingSell" class="tab-content outline w-100 h-75 text-light bg-transparent pm-0 mb-2"></div>
                        <div class="input-group input-group-md">
                            <div class="input-group-prepend">
                        ...
                        <button id="tSellBtn" class="btn btn-secondary w-50 align-self-center mt-auto disabled">Sprzedaj</button>
                    </div>
                    <div class="col-md-2 d-flex flex-column flank align-items-center justify-content-evenly"></div>
                </div>
            </div>
                ...
                <div class="row d-flex w-100 pm-0">
                    <div class="col-md-12 d-flex justify-content-space-around pm-0">
                        <div class="row d-flex w-100 pm-0 overflow-auto">
                            <div class="col-md-6 d-flex pt-1 pb-1 pm-0 w-100 h-auto bg-secondary justify-content-around">
                            ...
                            </div><div class="col-md-6 d-flex pt-1 pb-1 pm-0 w-100 h-auto bg-secondary justify-content-around">
                                </div><div class="col-md-12 d-flex pt-1 pb-1 pm-0 w-100 h-auto bg-secondary justify-content-around">
                                <?php endif; ?>
                                    <div title="<?=round(count($invItem))?>" class="p-2 bg-dark imgClass inventory-item <?=$ival?> text-light"></div>
