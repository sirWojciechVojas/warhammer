            ...
            <div class="modal-body" style="padding-top:0;">
                <div class="row d-flex">
                    ...
                    <div class="col-md-4 d-flex flex-column align-items-end">
                        ...
                        <div id="tradingBuy" class="row d-flex outline w-100 h-75 text-light bg-transparent pm-0 mb-2 align-items-start justify-content-center"></div>
                    ...
                    <div class="col-md-4 d-flex flex-column align-items-start">
                        ...
                        <div id="tradingSell" class="row d-flex tab-content outline w-100 h-75 text-light bg-transparent pm-0 mb-2 align-items-end justify-content-end"></div>
                        <div class="input-group input-group-md">
                            <div class="input-group-prepend">
