        ...
        <div class="modal-content" id="tradingStats">
            ...
            <div class="modal-body" style="padding-top:0;">
                <div class="row d-flex">
                    ...
                    <div class="outline col-md-2 d-flex flex-column flank align-items-center justify-content-around">
                        <button class="outline card square bg-light text-dark justify-content-center">Szblony-dodaj/edytuj</button>
                        <button class="outline card square bg-light text-dark">Stos-personalizuj</button>
                        <button class="outline card square bg-light text-dark">Sklep-ustal asortyment</button>
                    </div>
