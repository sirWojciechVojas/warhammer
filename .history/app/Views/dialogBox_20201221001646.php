    	...
    	<div class="modal-content" id="HPMenu">
      		...
      		<div class="modal-body<?=$addClass?>" style="padding:0 15px;">
				...
				<?php elseif($prefix == 'Inv'): ?>
					<div class="col-md-2 predesc m-2"><img src="<?= base_url('../warhammer/assets/img/inventory/Inventory_L[72x72]/' . $item['IMG_CLASS'] . '.png') ?>"/></div>
					<div class="col-md-10 predesc m-2">
