...
<div class="btn-group btn-group-vertical d-flex justify-content-between">
    <?php foreach ($dices as $num) : ?>
    <div style="width:32px;" class="d-flex justify-content-between">
        <?php
            $Knum = ($num=='3D') ? $num : 'K'.$num;
            $btnClass = ($num=='3D') ? ' btn-danger' : ' btn-primary';
        ?>
        <button type="button" style="width:32px;font-size:13px;" class="btn<?=$btnClass?>"
