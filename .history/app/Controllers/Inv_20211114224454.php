...
class Inv extends BaseController
{
	...
	public function tradingGM() {
		...
		$outputTbl->tGEdit  = $this->view->setVar('tGoods', $invBGModel->getInvTrash())->render('tGEdit');
