...
class Trading extends BaseController
{
	...
	public function tGoods() {
		...
		// $outputTbl->tGInd = htmlspecialchars($this->view->render('tGInd'));
		$outputTbl->tFlankL = htmlspecialchars($this->view->setVar('side', 'left')->render('tFlank'));
		$outputTbl->tFlankR = htmlspecialchars($this->view->setVar('side', 'right')->render('tFlank'));
