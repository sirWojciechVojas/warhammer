jQuery(function()
{
	...
	$('#trading').on('click','.GM,.leftGM', function (e) {
		...
		$this = $(this);
		if($this.index()==1) {$tsell = 'tTrash'; $tsellTitle='Stos'; $tBuyBtn='Spersonalizuj';$tSellBtn='Usuń';}
		// else if($this.index()==2) $tsell = tGInd;
		else if($this.index()==2) {$tsell = 'tTrash'; $tsellTitle='Stos'; $tBuyBtn='Spersonalizuj';$tSellBtn='Usuń';}
		else {
			$this.index() = 0;
			$tsell = 'tAdd';
