	...
	$('#HPMenu .modal-footer').on('click','.btn-danger', function (e) {
		...
		$.ajax({
			...
			success: function(data) {
				...
				$firstPD.attr('data-original-title','<h6><b>Punkty Doświadczenia</b></h6><h6><u>Pasek kompleksowy</u></h6><h6>'+b+'/'+c+' PD<br>(niewykorzytane: '+a+' PD)sss</h6>');
				$firstPD.next().data({'original-title':'<h6><b>Punkty Doświadczenia</b></h6><h6><u>Pasek minimalny</u></h6><h6>'+b+ '/'+c+' PD<br>(niewykorzytane: '+a+' PD)</h6>'});
				activateTooltip();
