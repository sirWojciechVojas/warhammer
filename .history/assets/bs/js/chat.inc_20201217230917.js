...
0
	...
	$('#HPMenu .modal-footer').on('click','.btn-danger', function (e) {
		$this=$(this);
		$PDbar = $('#characterPanel .footerSpace');
		...
		$.ajax({
			...
			success: function(data) {
				...
				$firstPD.attr('data-original-title','<h6><b>Punkty Doświadczenia</b></h6><h6><u>Pasek kompleksowy</u></h6><h6>'+b+'/'+c+' PD<br>(niewykorzytane: '+a+' PD)</h6>');
