...
class InvBGModel extends Model {
	...
	public function getInvTrash() {
		$trashTbl = $this->db->table('w_ekwipunek')->join('w_ekwipunek_bg','w_ekwipunek_bg.INV_ID = w_ekwipunek.ID','left')->where('w_ekwipunek_bg.OWNER_OPT',2)->where('w_ekwipunek_bg.DELETED_AT',NULL)->get()->getResultArray();
